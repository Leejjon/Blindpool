...
import { getTranslationFunctionBasedOnHost } from "../locales/i18next.server";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const TITLE = t("TITLE");
  const COMPETITIONS_TITLE = t("COMPETITIONS_TITLE");
  const CREATE_POOL = t("CREATE_POOL");
  const HOW_DOES_IT_WORK_TITLE = t("HOW_DOES_IT_WORK_TITLE");
  const BLINDPOOL_DEFINITION_TITLE = t("BLINDPOOL_DEFINITION_TITLE");
  const BLINDPOOL_DEFINITION_DESCRIPTION = t("BLINDPOOL_DEFINITION_DESCRIPTION");
  const UPCOMING_MATCHES = t("UPCOMING_MATCHES");
