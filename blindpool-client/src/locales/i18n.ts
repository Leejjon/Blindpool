...
export const resources = {
    en: {
        translation: {
            ...
            "UPCOMING_MATCHES_FAILURE": "Something went wrong with loading the matches",
    ...
    nl: {
        translation: {
            ...
            "UPCOMING_MATCHES_FAILURE": "Er is iets fout gegaan bij het ophalen van de wedstrijden.",
