...
export const resources = {
    en: {
        translation: {
            ...
            "UPCOMING_MATCHES_FAILURE": "Failed to retrieve matches from our server. We hope to fix this as fast as possible.",
    ...
    nl: {
        translation: {
            ...
            "UPCOMING_MATCHES_FAILURE": "Het ophalen van de wedstrijden is mislukt. We hopen dit zo snel mogelijk op te lossen.",
